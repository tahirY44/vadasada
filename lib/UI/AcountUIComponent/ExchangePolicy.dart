...
class exchangePolicy extends StatefulWidget {
  @override
  _exchangePolicyState createState() => _exchangePolicyState();
}

class _exchangePolicyState extends State<exchangePolicy> {
  var page_data = '';
  bool _loading = false;

  getData() async {
    var parameters = {'appkey': Api.appkey, 'slug': 'returns-refunds'};
