...
class shippingDelivery extends StatefulWidget {
  @override
  _shippingDeliveryState createState() => _shippingDeliveryState();
}

class _shippingDeliveryState extends State<shippingDelivery> {
  var page_data = '';
  bool _loading = false;

  getData() async {
    var parameters = {'appkey': Api.appkey, 'slug': 'shipping-delivery'};
