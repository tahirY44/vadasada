...
class EditProduct extends StatefulWidget {
  ...
  @override
  _EditProductState createState() => _EditProductState(id: id);
}

class _EditProductState extends State<EditProduct>
    with TickerProviderStateMixin {
  int id;
  _EditProductState({@required this.id});
  ...
  getProductById() async {
    ...
    setState(() {
      ...
      productSkuController.text = data['product_code'];
      priceController.text = data['price'].toString();
      discountedController.text = data['discounted'].toString();
      _loading = false;
    });
  }
  ...
  editProduct(context) async {
    ...
    if (_formKey.currentState?.validate()) {
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse(Api.httpBaseURL + Api.product_update));
